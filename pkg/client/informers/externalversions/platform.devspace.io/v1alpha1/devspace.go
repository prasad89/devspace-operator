...
import (
	...
	v1alpha1 "pkg/client/listers/platform.devspace.io/v1alpha1"
	time "time"

	platformdevspaceiov1alpha1 "github.com/prasad89/devspace-operator/pkg/apis/platform.devspace.io/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformV1alpha1().DevSpaces(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformV1alpha1().DevSpaces(namespace).Watch(context.TODO(), options)
			},
		},
		&platformdevspaceiov1alpha1.DevSpace{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *devSpaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformdevspaceiov1alpha1.DevSpace{}, f.defaultInformer)
}
