...
// PlatformV1alpha1Client is used to interact with features provided by the platform.devspace.io group.
type PlatformV1alpha1Client struct {
	restClient rest.Interface
}

func (c *PlatformV1alpha1Client) DevSpaces(namespace string) DevSpaceInterface {
