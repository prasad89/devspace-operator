...
var devspacesResource = schema.GroupVersionResource{Group: "platform.devspace.io", Version: "v1alpha1", Resource: "devspaces"}

var devspacesKind = schema.GroupVersionKind{Group: "platform.devspace.io", Version: "v1alpha1", Kind: "DevSpace"}
...
func (c *FakeDevSpaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(devspacesResource, c.ns, name), &v1alpha1.DevSpace{})
