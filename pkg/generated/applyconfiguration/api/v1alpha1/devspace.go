...
// DevSpaceApplyConfiguration represents a declarative configuration of the DevSpace type for use
// with apply.
...
func (b *DevSpaceApplyConfiguration) WithOwnerReferences(values ...*v1.OwnerReferenceApplyConfiguration) *DevSpaceApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *DevSpaceApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *DevSpaceApplyConfiguration) WithStatus(value *DevSpaceStatusApplyConfiguration) *DevSpaceApplyConfiguration {
	b.Status = value
	return b
}
